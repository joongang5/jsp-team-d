	...
	<div id="container">
		...
		<div id="main">
			...
			<c:if test="${empty authUser}">
				...
				<a href="https://kauth.kakao.com/oauth/authorize?client_id=188766d70b45863a165fa74d7d8a455b&redirect_uri=https://172.30.1.48:8080/BBS/index.do?cmd=callback&response_type=code">
